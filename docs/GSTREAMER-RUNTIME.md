...
The pinned zlib recipe/component provenance remains zlib.net; formal
acquisition uses the official GStreamer mirror URL with the same filename and
SHA, pre-seeded into Cerbero's resolved local source cache before fetch.
